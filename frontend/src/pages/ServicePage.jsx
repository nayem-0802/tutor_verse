...
<main className="flex-grow px-4 sm:px-10 py-10">
  <div className="max-w-6xl mx-auto text-center">
    <h1 className="text-4xl font-bold text-[#70B44A] mb-10">Our Services</h1>

    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-left">

      <div className="bg-[#FBFDF7] border rounded-xl text-center shadow-md p-6 hover:shadow-lg transition">
