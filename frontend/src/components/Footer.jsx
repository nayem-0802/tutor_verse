    ...
    <footer className="bg-[#FBFDF7] border-t border-gray-200 px-4 py-6 text-sm text-gray-600">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center sm:items-start gap-4">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="flex justify-center sm:justify-start items-center gap-1 text-sm "><IoMdCall />01700112233</p>
          <p className="flex items-center gap-1 text-sm"><TfiEmail/> <a href="mailto:tutorverse.support@email.com">tutorverse.support@email.com</a></p>
        </div>
      </div>
    </footer>
  );
